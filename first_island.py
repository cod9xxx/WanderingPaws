    ...
    def update_animation(self, delta_time: float = 1 / 60):
        ...
        if is_moving:
            ...
            if self.step_timer >= self.step_interval:
                ...
                random_step = random.choice(self.step_sounds)
                arcade.play_sound(random_step, volume=0.2)
        ...
        frame_index = (self.cur_frame // UPDATES_PER_FRAME) % len(textures)
...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        map_name = r'tilemaps\1_island.tmx'
